      ...
      <div className="mt-3 flex flex-wrap items-center gap-4">
        ...
        {dateRange && (
          <button
            ...
            className="min-h-[44px] rounded-full border border-border px-4 py-2.5 text-xs font-semibold text-text-muted transition-colors hover:bg-surface-2 hover:text-text focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
          >
            Reset range
          </button>
        )}
